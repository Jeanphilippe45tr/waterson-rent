  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p>It is above all the uncompromising, performance-oriented aesthetic that unmistakeably reveals its ambitions.
          Not elegant but extravagant. Not conventional but individual.</p>
      </div>
      <div class="row">
                ...
                <div class="col-list-3">
                  <div class="recent-car-list">
                    ...
                    <div class="car-title-m">
                      ...
                      <span class="price">XAF<?php echo htmlentities($result->PricePerDay); ?> /Day</span>
                    </div>
